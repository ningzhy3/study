...
3. number of black nodes from root to node with less than 2 children is the same 
...
2. insert new leaf node as red
   ...
   ​	if black or absent sibling rotate, recolor done

   ​	if red sibling then recolor check again

```java
570 lines (527 sloc)  21.4 KB
